...
For the engine I primarily focused on Graphics , Technical Art , Tools and Editor with an emphasis on Graphics and Technical Art.
            ...
            <div class = "project-list">
                <div class = "project-list-item">OpenGL</div>
                <div class = "project-list-item"> ImGui</div>
                <div class = "project-list-item"> JsonCpp</div>
                <div class = "project-list-item"> C++</div>
                <div class = "project-list-item"> C#</div>
              </div>
          </div>
        </div>
          ...
          <div class="project-content">
            ...
            <div class="project-details">
              ...
              <div class = "project-list">
                <div class = "project-list-item">OpenGL</div>
                <div class = "project-list-item"> C++</div>
                <div class = "project-list-item"> Qt</div>
              </div>
            </div>
          </div> 
        </div>
...
For the assets of the website - arnold renderer is being used for lights mapping the scene with the map being combined into a mesh.
              ...
              <div class = "project-list">
                <div class = "project-list-item">React</div>
                <div class = "project-list-item"> Html</div>
                <div class = "project-list-item"> CSS</div>
                <div class = "project-list-item"> Javascript</div>
                <div class = "project-list-item"> three.js</div>
                <div class = "project-list-item"> webGL</div>
                <div class = "project-list-item"> Netlify</div>
              </div>
          </div>
        </div>
